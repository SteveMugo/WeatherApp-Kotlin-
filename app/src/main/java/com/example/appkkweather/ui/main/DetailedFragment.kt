...
import com.example.appkkweather.databinding.FragmentDetailedBinding
import com.example.appkkweather.ui.favorite.FavoriteViewModel
import com.example.appkkweather.ui.forecast.ForecastAdapter
import com.example.appkkweather.ui.forecast.ForecastViewModel
import com.example.appkkweather.ui.forecast.ForecastWeather
import com.example.appkkweather.ui.user.SignInDialog
...
class DetailedFragment : Fragment(R.layout.fragment_detailed) {
    ...
    override fun onCreateView(
        ...
        context?.let {
            ForecastWeather(forecastViewModel, it).getForecast(
                binding.progressBar,
                data_lat,
                data_long
            )
    ...
    private fun initUI() {
        ...
        binding.forecastTitle.text = "$data_city, 5 Day forecast."

        binding.currentFocastBg.setBackgroundResource(BackgroundManager().getOverallHomeBackground(data_description))
