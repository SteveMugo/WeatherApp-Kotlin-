...
import com.example.appkkweather.R.id.search_src_text
import com.example.appkkweather.core.BaseFragment
import com.example.appkkweather.databinding.FragmentSearchBinding
...
import com.example.appkkweather.ui.search.result.SearchResultAdapter
import com.example.appkkweather.utils.extensions.hideKeyboard
...
class SearchFragment : BaseFragment<SearchViewModel, FragmentSearchBinding>(
    ...
    private fun initSearchView() {
        val searchEditText: EditText = binding.searchView.findViewById(search_src_text)
