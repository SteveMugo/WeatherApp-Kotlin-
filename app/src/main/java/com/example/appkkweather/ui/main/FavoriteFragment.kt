...
import com.example.appkkweather.data.cloud.FavoriteDataModel
import com.example.appkkweather.databinding.FragmentFavoriteBinding
import com.example.appkkweather.model.favoriteModel
import com.example.appkkweather.ui.citiesWeather.cityDetailInterface
import com.example.appkkweather.ui.favorite.FavoriteAdapter
...
class FavoriteFragment : Fragment(R.layout.fragment_favorite), cityDetailInterface {
    ...
    private fun initUI() {
        ...
        binding.searchBtn.setOnClickListener{
            ...
            if(!binding.searchViewLayout.isVisible){

                binding.searchViewLayout.isVisible = true
                binding.searchViewLayout.startAnimation(AnimationUtils.loadAnimation(context,R.anim.slide_down))
                binding.favRecyclerViewLayout.startAnimation(AnimationUtils.loadAnimation(context,R.anim.slide_down))

            }else{
                binding.searchViewLayout.isVisible = false
                binding.favRecyclerViewLayout.startAnimation(AnimationUtils.loadAnimation(context,R.anim.slide_up))
            }
